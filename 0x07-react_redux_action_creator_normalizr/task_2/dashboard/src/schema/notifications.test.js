import { normalizedNotifications } from './Notifications.js';
...
describe('Normalized Data', () => {
  ...
  it('should have the correct user entity for the id 5debd764a7c57c7839d722e9', () => {
    const expectedUser = {
      age: 25,
  ...
  it('should have the correct message entity for the guid efb6c485-00f7-4fdf-97cc-5e12d14d6c41', () => {
  ...
  it('should have the correct notification entity for the id 5debd7642e815cd350407777', () => {
